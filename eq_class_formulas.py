...
def grant_msg(n, eq_class):
    return bool(eq_class_bin[eq_class][0 + n])

def held(eq_class):
    return bool(eq_class_bin[eq_class][3])

def hold_msg(n, eq_class):
    return bool(eq_class_bin[eq_class][4 + n])

def lock_msg(n, eq_class):
    return bool(eq_class_bin[eq_class][7 + n])

def unlock_msg(n, eq_class):
    return bool(eq_class_bin[eq_class][10 + n])
